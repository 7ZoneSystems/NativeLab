...
> See [docs/features.md](docs/features.md) for the full v0.2.9 changelog and [docs/architecture.md](docs/architecture.md) for the layered design.
...
| [docs/features.md](docs/features.md) | What's new in v0.2.9 + the full feature catalogue. |
