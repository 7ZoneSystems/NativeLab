...
from PyQt6.QtCore import pyqtProperty,Qt, QThread, pyqtSignal, QTimer, QEvent, QRect, QPointF, QPropertyAnimation, QEasingCurve, QDataStream, QIODevice, QVariant  # pyright: ignore[reportAttributeAccessIssue]
